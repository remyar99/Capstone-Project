...
resource "aws_subnet" "public-subnet-1a" {
  ...
  tags = {
    Name = "capstone-public-subnet-ap-1a"
...
resource "aws_subnet" "public-subnet-ap-1b" {
  vpc_id     = "${aws_vpc.vpc.id}"
  ...
  tags = {
    Name = "capstone-public-subnet-ap-1b"
    "kubernetes.io/cluster/${local.eks_cluster_name}" = "Shared"
    "kubernetes.io/role/elb" = "1"
  }
}
...
resource "aws_subnet" "private-subnet-ap-1b" {
  vpc_id     = "${aws_vpc.vpc.id}"
  cidr_block = "10.0.4.0/24"
  availability_zone = "ap-south-1b"

  tags = {
    Name = "private-subnet-1b-project"
    "kubernetes.io/cluster/${local.eks_cluster_name}" = "Shared"
    "kubernetes.io/role/internal-elb" = "1"
  }
}
...
resource "aws_route_table" "routeTablePub" {
  ...
  tags = {
    Name = "Remya-routeTablePub-project"
  }
}
